...
table_mapping[f'dothis_exp.video_history_shorts_' + yyyymm_str] = {
    'target_table': f'dothis.video_history_shorts_' + yyyymm_str,
    'columns': ['video_id','video_views','video_likes','video_comments','video_performance','year','month','day','video_cluster'],
    'where_clause': 'year*10000+month*100+day in (' + one_day_before_str + ',' + today_str + ')'
}
print(table_mapping[f'dothis_exp.video_history_shorts_' + yyyymm_str])
